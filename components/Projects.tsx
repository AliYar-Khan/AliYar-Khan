        ...
        <div className='flex-col flex md:flex-row  mt-7'>
          ...
          >
            <div className='flex-row flex mb-5'>
              ...
              />
              <div className='p-3'>
                <p className='text-white font-semibold text-xl'>Arziii</p>
                <p className='text-gray-500 text-[10px]'>
                  Full Stack web application using MERN stack, which allows
                  users to design ebooks for children adults using canvas.
                  Additional AI integrations helps generate interesting stories
                  and arts for books.
                </p>
              </div>
            </div>
