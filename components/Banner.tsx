    ...
    <div className='flex flex-row items-center justify-center px-20 mt-[100px] z-[20] '>
      <div className='flex flex-col  justify-center  text-center'>
        ...
        <p className='text-md text-gray-200 my-5 max-w-[600px]'>
          Passionate Software Engineer with a focus on MERN Stack & React Native
          development, dedicated to crafting elegant and user-friendly full
          stack web and mobile applications.
        </p>
        <div className='text-md flex justify-center'>
          <button
            onClick={() => window.open('mailto:aliyark145@gmail.com')}
